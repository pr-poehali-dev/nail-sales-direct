...
const Index = () => {
  ...
  const products = [
    {
      category: "Строительные гвозди",
      items: [
        { name: "Гвозди 50мм", specs: "Ø 2.5мм, оцинкованные", price: "от 120 ₽/кг" },
        { name: "Гвозди 70мм", specs: "Ø 3.0мм, черные", price: "от 95 ₽/кг" },
        { name: "Гвозди 100мм", specs: "Ø 4.0мм, оцинкованные", price: "от 130 ₽/кг" },
      ]
    },
    {
      category: "Кровельные гвозди",
      items: [
        { name: "Толевые 25мм", specs: "Широкая шляпка, Ø 2.5мм", price: "от 145 ₽/кг" },
        { name: "Шиферные 90мм", specs: "С резиновой прокладкой", price: "от 160 ₽/кг" },
      ]
    },
    {
      category: "Финишные гвозди",
      items: [
        { name: "Финишные 40мм", specs: "Малая шляпка, Ø 1.8мм", price: "от 175 ₽/кг" },
        { name: "Финишные 60мм", specs: "Малая шляпка, Ø 2.0мм", price: "от 180 ₽/кг" },
      ]
    },
    {
      category: "Специальные гвозди",
      items: [
        { name: "Дюкерт-гвозди", specs: "Для паркета и досок", price: "от 210 ₽/кг" },
        { name: "Винтовые гвозди", specs: "Повышенная прочность", price: "от 195 ₽/кг" },
      ]
    }
  ];
